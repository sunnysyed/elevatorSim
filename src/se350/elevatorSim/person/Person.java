...
public interface Person {
	...
	/**
	 * Get the status of the person, useful for finding out where a person is.
	 * 
	...
	/**
	 * Get the unique id for the person, useful for differentiating the
	 * different instances of the implementations.
	 * 
	...
	/**
	 * Called when the Person arrives at the destination to measure how long
	 * their ride was.
	 */
